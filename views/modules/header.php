    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="dropdown-header"><?php echo $notificationCount; ?> Notifications</div>
          <div class="dropdown-divider"></div>

          <?php foreach ($unreadNotifications as $notification) : ?>
              <?php if ($notification['type'] === 'Stock notification') : ?>
                <a href="<?php echo $notification['currentRoute']; ?>" class="dropdown-item notification-link stock-notification" data-value1="<?php echo $notification['barcode']; ?>" data-value2="<?php echo $notification['session']; ?>">
                    <?php echo $notification['icon'] . ' ' . $notification['message'] . '<br>'; ?>
                    <span class="float-right text-muted text-sm"><?php echo $notification['formattedDuration']; ?></span><br>
                </a>
                <div class="dropdown-divider"></div>
              <?php elseif ($notification['type'] === 'Product deletion') : ?>
                <a href="<?php echo $notification['currentRoute']; ?>" class="dropdown-item notification-link product-deletion" data-value1="<?php echo $notification['value']; ?>" data-value2="<?php echo $notification['session']; ?>" data-value3="<?php echo $notification['name']; ?>" data-value4="<?php echo $notification['message'];?>">
                    <?php echo $notification['icon'] .' '. $notification['name'] . ' wants to delete the product '. $notification['product'] ; ?><br>
                    <span class="float-right text-muted text-sm"><?php echo $notification['formattedDuration']; ?></span><br>
                </a>
                <div class="dropdown-divider"></div>
              <?php elseif ($notification['type'] === 'Category deletion') : ?>
                <a href="<?php echo $notification['currentRoute']; ?>" class="dropdown-item notification-link category-deletion" data-value1="<?php echo $notification['value']; ?>" data-value2="<?php echo $notification['session']; ?>" data-value3="<?php echo $notification['name']; ?>" data-value4="<?php echo $notification['message'];?>">
                <?php echo $notification['icon'] .' '. $notification['name'] . ' wants to delete the ' . $notification['category'] . ' category.'; ?><br>
                    <span class="float-right text-muted text-sm"><?php echo $notification['formattedDuration']; ?></span><br>
                </a>
                <div class="dropdown-divider"></div>
              <?php elseif ($notification['type'] === 'Admin feedback' && $notification['viewUser'] === $_SESSION['username']) : ?>
                <a href="<?php echo $notification['currentRoute']; ?>" class="dropdown-item notification-link admin-feedback" data-value1="<?php echo $notification['notificationType']; ?>" data-value2="<?php echo $notification['session']; ?>">
                <?php echo $notification['icon'] . $notification['message'] ; ?><br>
                    <span class="float-right text-muted text-sm"><?php echo $notification['formattedDuration']; ?></span><br>
                </a>
                <div class="dropdown-divider"></div>
